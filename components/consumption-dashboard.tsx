...
export default function ConsumptionDashboard() {
  try {
    console.log('ConsumptionDashboard rendering');
    ...
    console.error('Error in ConsumptionDashboard:', error);
    return <div>An error occurred while rendering the dashboard.</div>;
  }
}